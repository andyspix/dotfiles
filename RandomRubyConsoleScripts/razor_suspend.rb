all_iccids = Account.find(816).devices.pluck(:iccid)
data1 = Account.find(816).devices.joins(:state_change_histories).where('state_change_histories.previous_state': 'suspend'); 0
data2 = Account.find(816).devices.joins(:state_change_histories).where('state_change_histories.state': 'suspend'); 0
